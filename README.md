...
Este projeto foi desenvolvido com o propósito de aprender e aumentar mais meus conhecimentos a montar um sistema de api utilizando nodejs. Sabendo disso, utizei as seguintes tecnologias:
...
$ git clone https://github.com/SilvaneiMartins/sambarber-backend/

# Go into the repository
$ cd sambarber-backend
...
## :memo: License
Este projeto está sob a licença MIT. Veja o [LICENSE](https://github.com/SilvaneiMartins/sambarber-backend/blob/master/LICENSE) for more information.
